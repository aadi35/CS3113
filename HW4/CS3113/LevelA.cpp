...
void LevelA::initialise()
{
   ...
   mGameState.enemy = new Entity({mOrigin.x + 600.0f, mOrigin.y - 200.0f}, {50.0f, 50.0f}, "assets/game/slime_green.png", ATLAS, {3, 4}, slimeAnimationAtlas, NPC);
   ...
   //mGreenSlime->setColliderDimensions({100.0f, 50.0f});
